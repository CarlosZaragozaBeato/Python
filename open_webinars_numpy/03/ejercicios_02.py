...
np.log10(_)
#Ejercicio 3
#Haciendo uso de la matriz 3x3 creada en el ejercicio anterior y del
# siguiente array a, calcule:

 

#La suma de la matriz más el vector
#La división de ambos. ¿qué ocurre? Modifique el valor extraño por 0.
#El valor máximo de la matriz resultado de la división. ¿y por filas?
# ¿y por columnas?
