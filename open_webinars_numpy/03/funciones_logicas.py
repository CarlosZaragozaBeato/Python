...
#Numpy nos proporciona una serie de funciones lógicas para realizar comprobaciones.
# Todas las funciones que veamos en esta lección devuelven como resultado True
# o False
...
# logical_and : Función lógica and. Devuelve True si todas las comprobaciones 
# son ciertas
np.logical_and(a > 2, a < 4)

# logical_or : Función lógica or. Devuelve True si alguna de las comprobaciones
# son ciertas
