...
received is 26.0, it should be printed as 26) In case of input data being supplied to the question, it should be assumed to be a console input.
...
nueva_lista = []
for num in lista:
    nueva_lista.append(calcular(num))
...
Question: Write a program which takes 2 digits, X,Y
...
for i in range(0,x):
    nueva_lista = []
    for i in range(0,y):
        nueva_lista.append(random.randint(0,150))
...
Question: Write a program that accepts a comma separated sequence of words as
 ...
 alphabetically. Suppose the following input is supplied to the program: without,hello,bag,world Then, the output should 
 be: bag,hello,without,world

Hints: In case of input data being supplied to the question, it should be
 assumed to be a console input.

cadena = input("Introduce una cadena de palabras separadas por comas: ")
cadena_dividida = cadena.split(",")
cadena_dividida.sort()
...
Question£º Write a program that accepts sequence of lines as input and prints the lines after making 
all characters in the sentence capitalized. Suppose the following input is supplied to the program: Hello world
...
while True:
    if cadena =="": break
    lista.append(cadena.upper()+" PRACTICE MAKES PERFECT")
    cadena = input("Introduce una cadena: ")
...
Question: Write a program that accepts a sentence and calculate the number of letters and digits. Suppose the following input
is supplied to the program: hello world! 123 Then, the output should be: LETTERS 10 DIGITS 3
...
for i in cadena:
    if i.isdigit():
        ...
        alpha +=1
print(f"The number of letter is {alpha} and the number of digit is {digit}")
...
for i in cadena:
    if i.isupper():
        ...
        lowers += 1
print(f"The number of letters in uppercase is {uppers}, and the number of letters in lowercase is {lowers}")
*******************************
Question 15
Level 2
...
numero = "9" #(input("Introduce un numero para reemplazar: "))

numero_nuevo = int(character.replace(character,numero))

operation = numero_nuevo + int(f"{numero_nuevo}{numero_nuevo}")+int(f"{numero_nuevo}{numero_nuevo}{numero_nuevo}")+int(f"{numero_nuevo}{numero_nuevo}{numero_nuevo}{numero_nuevo}")
print(operation)
...
valores = input("Introduce valores separados por comas: ")
...
def GenerateDictSquare():
    dictionary = {}
    for i in range(0,21):
        dictionary[i] = i**2
    return dictionary

for value in GenerateDictSquare().values():
    print(value)    
*******************************
Question 36
...
for key in GenerateDictSquare().keys():
    print(key)
*******************************
Question 37
