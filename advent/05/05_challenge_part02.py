...
for Move in movements:
    ...
    if (numToMove > 1):
        # Put each one to list and then put them back
        moveMultiColums = formatedColums[numMoveFrom - 1][-numToMove:]
        formatedColums[numMoveFrom - 1] = formatedColums[numMoveFrom - 1][:-numToMove]
        formatedColums[numMoveTo - 1] += moveMultiColums 
    else:
