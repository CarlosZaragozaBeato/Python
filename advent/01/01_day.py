...
brought with them, one item per line. Each Elf separates their own inventory from the previous Elf's inventory (if any) by a blank line.
...
##################################################################################################################333
def group_calories(array, index = 0):
    value = 0
    if array[index] == '':
        return 0
    else: 
        value = int(array[index])
        return value + group_calories(array, index+1)
#print(group_calories(divided))
"""

calories = "1000\n2000\n3000\n\n4000\n\n5000\n6000\n\n7000\n8000\n9000"


divided = calories.split("\n")
print(divided)
...
for i in range(len(divided)):
    if divided[i] != '':
        valor += int(divided[i])
    if divided[i] == '':  
        lista_buena.append(valor)
        valor = 0   
    if  i == len(divided) -1:
        lista_buena.append(valor)

print(max(lista_buena))
